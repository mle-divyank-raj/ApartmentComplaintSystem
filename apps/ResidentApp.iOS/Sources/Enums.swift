...
enum TicketStatus: String, Codable, CaseIterable {
    ...
    // Ordered steps for status timeline display
    static var timelineOrder: [TicketStatus] {
...
// MARK: - ComplaintCategory (client-side enum matching API string values)

enum ComplaintCategory: String, CaseIterable {
